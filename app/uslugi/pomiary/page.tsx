...
export default function MeasurementsPage() {
  return (
    <main className="min-h-screen bg-background-dark text-white">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-center justify-center pt-20 hero-gradient overflow-hidden">
        <div className="absolute inset-0 opacity-20 pointer-events-none industrial-grid"></div>
