...
export default function BhpServicesPage() {
  return (
    <main className="min-h-screen bg-background-dark text-white">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[70vh] flex items-center overflow-hidden border-b border-white/5 pt-20 animate-fade-in">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20 py-20">
          <div className="max-w-2xl">
            ...
            <p className="text-slate-400 text-lg md:text-xl font-medium leading-relaxed animate-fade-in" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10 border border-white/10">
            {bhpMainServices.map((service, index) => (
              <div key={index} className={`bg-card-dark p-12 group hover:bg-primary transition-all duration-500 animate-fade-in hover:scale-105 transform origin-center ${service.fullWidth ? 'lg:col-span-2' : ''}`} style={{ animationDelay: `${index * 0.1}s` }}>
