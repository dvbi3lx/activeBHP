...
${message}
  ...
  return (
    <main className="min-h-screen bg-background-dark text-white">
      ...
      {/* Header Section */}
      <header className="pt-32 pb-12 px-4 sm:px-6 md:px-12 max-w-7xl mx-auto overflow-hidden">
        <AnimatedSection variant="fade-right" delay={0.1} className="flex items-start gap-4 sm:gap-6">
          <div className="w-1 sm:w-2 h-16 sm:h-20 bg-primary shrink-0"></div>
          <div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black italic uppercase tracking-tighter leading-none mb-4 sm:mb-6 drop-shadow-2xl">
      ...
      {/* Main Content */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 pb-24 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 overflow-hidden">
        {/* Contact Info Cards */}
        <div className="lg:col-span-5 space-y-4 sm:space-y-6">
          {contactInfo.map((info, index) => (
            <AnimatedSection key={index} variant="fade-up" delay={0.1 * index}>
              <div className="bg-card-dark p-6 sm:p-8 border border-white/5 hover:border-primary/50 transition-colors group">
        ...
        <div className="lg:col-span-7">
          <AnimatedSection variant="fade-left" delay={0.2} className="h-full">
            <div className="bg-card-dark p-6 sm:p-8 md:p-12 border border-white/10 h-full">
      ...
      <section className="relative overflow-hidden border-t border-white/10">
        <AnimatedSection variant="fade-up" delay={0.2} className="w-full h-[500px] md:h-[600px] grayscale hover:grayscale-0 transition-all duration-700">
          <iframe
